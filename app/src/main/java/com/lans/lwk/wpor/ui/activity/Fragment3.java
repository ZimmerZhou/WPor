...
//            "21:00","22:00","23:00","24:00"};//X轴的标注
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initLineChart(lineChart,mPointValues,mAxisXValues,points);//初始化
        return view;
    }

    public static void initLineChart(LineChartView lineChart,List<PointValue> mPointValues,List<AxisValue> mAxisXValues,int [] points){
        /**
         * 设置X 轴的显示
         */
...
//        }
        ...
        for (int i = 0; i < points.length; i++) {
            mPointValues.add(new PointValue(i, points[i]));
        }
